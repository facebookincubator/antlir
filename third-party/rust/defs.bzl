...
def buildscript_run(name, buildscript_rule, package_name, version, **kwargs):
    ...
    _prelude_buildscript_run(name = name, buildscript_rule = buildscript_rule, package_name = package_name, version = version, **kwargs)
