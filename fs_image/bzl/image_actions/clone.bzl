...
load("//fs_image/bzl:image_source.bzl", "image_source")
load("//fs_image/bzl:target_tagger.bzl", "image_source_as_target_tagged_dict", "new_target_tagger", "tag_target", "target_tagger_to_feature")
...
def image_clone(src_layer, src_path, dest_path):
    ...
    return target_tagger_to_feature(
        ...
        extra_deps = ["//fs_image/bzl/image_actions:clone"],
    )
