...
def main(argv):
    ...
    parser.add_argument(
        ...
        type=int, nargs=4, default=(0, 0, 2 ** 64, 10 ** 9),
    ...
    parser.add_argument(
        '--show-only', type=str, action='append',
    ...
    parser.add_argument(
        'sendstream', type=argparse.FileType('br'), nargs='+',
