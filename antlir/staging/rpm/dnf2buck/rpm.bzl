...
rpm = rule(
    ...
    attrs = {
        ...
        "rpm": attrs.option(attrs.source()),
        "sha256": attrs.string(),
        "url": attrs.option(attrs.string()),
        "xml_filelists": attrs.option(attrs.source(doc = "filelists.xml chunk")),
        "xml_other": attrs.option(attrs.source(doc = "other.xml chunk")),
        "xml_primary": attrs.option(attrs.source(doc = "primary.xml chunk")),
    },
)
