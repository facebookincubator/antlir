...
_SIGNER_T = types.optional(types.exe)
_LABEL_OPT = types.optional(types.label)
_FLAVOR_T = types.optional(types.union(types.str, types.shape(flavor_t)))

types.lint_noop(_SIGNER_T, _LABEL_OPT, _FLAVOR_T)
