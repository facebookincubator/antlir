...
class NetnsSocketTestCase(AntlirTestCase):
    ...
    def test_create_sockets_inside_netns(self, s_patch, r_patch, enabled_patch) -> None:
        expected_cmd = [
            "sudo",
            "env",
        ...
        expected_cmd.extend(_make_sockets_and_send_via(num_socks=1, unix_sock_fd=1))
        ...
        self.assertIsInstance(create_sockets_inside_netns(1, 1)[0], socket.socket)
